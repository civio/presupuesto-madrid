...
class MadridMainInvestmentsLoader(MainInvestmentsLoader):
    ...
    def get_image_URL(self, project_id):
        IMAGES = {
          '14': 'https://images.weserv.nl/?url=transparencia.madrid.es/FWProjects/transparencia/Imagenes/PresupuestosAbiertos/14_CodigoPEP.jpg&w=300',
          '21': 'https://images.weserv.nl/?url=transparencia.madrid.es/FWProjects/transparencia/Imagenes/PresupuestosAbiertos/21_CodigoPEP.jpg&w=300',
