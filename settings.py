...
EXTRA_URLS = (
    ...
    url(r"^admin/execution$", "admin_execution"),
    ...
    url(r"^admin/inflation$", "admin_inflation"),
    ...
    url(r"^admin/population$", "admin_population"),
    ...
    url(r"^admin/payments$", "admin_payments"),
    ...
    url(r"^admin/glossary$", "admin_glossary"),
    url(r"^admin/glossary/es$", "admin_glossary_es"),
    ...
    url(r"^admin/glossary/en$", "admin_glossary_en"),
