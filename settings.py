...
# Show an extra tab in the Policy page, showing budget goals and indicators. Default: False.
# XXX: This is temporarily enabled via local settings during development. See end of project/settings.py
