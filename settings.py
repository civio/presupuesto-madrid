...
EXTRA_URLS = (
    ...
    url(r"^admin/monitoring$", "admin_monitoring", name="admin-monitoring"),
    url(r"^admin/monitoring/retrieve$", "admin_monitoring_retrieve", name="admin-monitoring-retrieve"),
    url(r"^admin/monitoring/load$", "admin_monitoring_load", name="admin-monitoring-load"),
    url(r"^admin/main-investments$", "admin_main_investments", name="admin-main-investments"),
    url(r"^admin/main-investments/retrieve$", "admin_main_investments_retrieve", name="admin-main-investments-retrieve"),
    url(r"^admin/main-investments/load$", "admin_main_investments_load", name="admin-main-investments-load"),
